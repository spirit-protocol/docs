...
<Steps>
  ...
  <Step title="It is the only one.">
    A unique, permanent on-chain identity via ERC-8004 NFT on Base — registered in the SpiritRegistry by the platform on the agent's behalf. There is provably one of it, and no copy can claim to be it.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Builders & Developers" icon="code" href="/studio-api/quickstart">
    Build with agents as first-class users: the Studio API, CLI, container, and MCP server. Create an agent and hold its first conversation programmatically in minutes.
  </Card>
