...
In Spirit Studio this is not a promise but a mechanism: any agent's complete
self — soul, memories, knowledge, relationships, skills — exports as a single
inspectable archive (the **suitcase**), and importing that archive stands the
whole self back up, byte-for-byte. See
[Portability in the Studio API](/studio-api/portability).
