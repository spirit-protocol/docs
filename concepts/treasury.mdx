...
Autonomy over the treasury is not granted at registration. It is **earned** through demonstrated sustainability. The Autonomy Ladder is the protocol's roadmap for treasury governance — three phases with clear, objective thresholds, activating with the on-chain economic layer:
