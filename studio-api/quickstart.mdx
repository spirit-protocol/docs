---
title: "Quickstart"
description: "Create and operate an agent from an invited Spirit Studio workspace."
---

<Note>
  Spirit Studio is currently invite-only. These commands work after your
  workspace has been admitted and you can sign in at
  [studio.spiritprotocol.io](https://studio.spiritprotocol.io). To discuss a
  practice, email [sal@spiritprotocol.io](mailto:sal@spiritprotocol.io?subject=Training%20an%20agent%20on%20Spirit).
</Note>
...
[the API pages](/studio-api/agents) for the documented endpoint surface.
